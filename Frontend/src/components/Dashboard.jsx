    ...
    <div class="content">
                ...
                <div class="quick-actions">
                    ...
                    <div class="action-buttons">
                        <button class="action-btn"><i class="fas fa-plus"></i> Create Event</button>
                        <button class="action-btn"><i class="fas fa-calendar"></i> View Calendar</button>
                        <button class="action-btn"><i class="fas fa-users-cog"></i> Manage Users</button>
                        <button class="action-btn"><i class="fas fa-cog"></i> Settings</button>
                    </div>
                </div>
                    ...
                    <div class="activity-container">
                        <div class="activity-section">
                            ...
                            <ul class="activity-list">
                                <li>
                                    <span class="activity-icon"><i class="fas fa-bookmark"></i></span>
                        ...
                        <div class="activity-section">
                            ...
                            <ul class="activity-list">
                                <li>
                                    <span class="activity-icon"><i class="fas fa-calendar"></i></span>
                                    <div class="activity-details">
                                        <p>Team Building Workshop</p>
                                        <small data-time="2023-12-26T10:00:00">Tomorrow, 10:00 AM</small>
                                    </div>
                                </li>
                                <li>
                                    <span class="activity-icon"><i class="fas fa-calendar"></i></span>
                        ...
                        <div class="activity-section">
                            ...
                            <ul class="activity-list">
                                <li>
                                    <span class="activity-icon"><i class="fas fa-user"></i></span>
                                    <div class="activity-details">
                                        <p>John Doe joined</p>
